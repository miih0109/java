...
console.clear();
const e = '10';
if (e === 10) console.log('e é numeral de 10');
else {
...
if (f > 5 && g > 10) console.log('f é maior do que 5 e g é maior que 10');
else {
    console.log(`Condição é ${f > 5 && g > 10}`);
    console.log('f não é maior do que 5 pu g não é maior do que 10')
}
// Desvios encadeados 
console.clear();
const num = 'Olá';
